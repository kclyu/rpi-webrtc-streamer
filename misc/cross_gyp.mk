...
WEBRTCBUILD?=Debug
#WEBRTCBUILD?=Release
WEBRTCOUTPUT=arm/out
WEBRTCLIBPATH=$(WEBRTCROOT)/src/$(WEBRTCOUTPUT)/$(WEBRTCBUILD)

## WebRTC library build script
# GYP Build
WEBRTC_LIBRARY_BUILD=../scripts/webrtc_library_gyp.py $(WEBRTCROOT) $(WEBRTCOUTPUT)/$(WEBRTCBUILD)
